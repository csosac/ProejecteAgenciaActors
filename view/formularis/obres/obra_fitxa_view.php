    ...
    <div class="articulo contenido"> 
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-offset-3 col-md-6 col-lg-offset-3 col-lg-6  lletraViewActor">
                ...
                <div class="col-xs-12 col-sm-8"><img src="<?php echo 'view/images/actors/'.$actor->__GET('photoURL').'.png'; ?>" class="img-responsive img-rounded grande" alt="Cinque Terre"/></div>
                ...
                <div><h2>Genere:<?php if ($actor->__GET('genre')== 'female'){echo 'Dona';}
                                          else{echo 'Home';}?></h2></div>
                </div>
